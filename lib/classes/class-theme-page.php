		...
		public function display_fields() {
			...
			foreach ( $this->get_pages() as $panelsIndex => $panels ):
				...
				foreach ( $page_settings as $sectionIndex => $sections ):
					...
					$sections_options = isset( $sections['options'] ) ? $sections['options'] : array();
					
					foreach ( $sections_options as $option ) :
                    ...
                    <ul class="nav-items">
						...
						foreach ( $this->get_pages() as $page_id => $page ):
                            ...
                            <li class="nav-item-wrap <?php if ( ( $page_settings_count > 1 ) ) {
								...
								?><?php echo $page_id; ?>' class='nav-item'><?php echo $page_nav; ?>
								...
								if ( ( $page_settings_count > 1 ) ):
                                    ...
                                    <ul class="child-navs">
										...
										foreach ( $page_settings as $section_id => $nav_sections ):
											...
											$title = isset( $nav_sections['title'] ) ? $nav_sections['title'] : "";
											
											$nav_sections_title = ! empty( $nav_sections['nav_title'] ) ? $nav_sections['nav_title'] : $title;
